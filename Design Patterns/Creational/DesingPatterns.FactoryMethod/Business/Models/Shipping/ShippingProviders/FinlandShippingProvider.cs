...
{
    public class FinlandShippingProvider : ShippingProvider
    {
        public FinlandShippingProvider(ShippingCostCalculator shippingCostCalculator)
        {
