...
namespace Camp.Data.Migrations
{
    ...
    [Migration("20220121204125_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Camp.Entites.Camp", b =>
                {
            ...
            modelBuilder.Entity("Camp.Entites.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Camp.Entites.Speaker", b =>
                {
            ...
            modelBuilder.Entity("Camp.Entites.Talk", b =>
                {
            ...
            modelBuilder.Entity("Camp.Entites.Camp", b =>
                {
                    b.HasOne("Camp.Entites.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Camp.Entites.Talk", b =>
                {
                    b.HasOne("Camp.Entites.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("Camp.Entites.Speaker", "Speaker")
                        .WithMany()
